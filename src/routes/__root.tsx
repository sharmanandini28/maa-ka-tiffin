...
import { isSupabaseConfigured, warnIfBackendMissing } from "@/lib/config";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maa Jaisa Tiffin — Ghar Jaisa Shuddh Tiffin in Noida" },
      {
        name: "description",
        content:
          "Pre-order home-style vegetarian tiffin in Noida. Farm-fresh, trusted-source ingredients. No palm oil, no milawat, no heavy masala. Lunch & dinner delivery.",
      },
      { name: "author", content: "Maa Jaisa Tiffin" },
...
function RootComponent() {
  ...
  useEffect(() => {
    // Public marketing pages must load even when the backend is not configured.
    ...
    try {
      ...
      console.warn("[config] Auth listener could not start:", err);
    }
  }, [router, queryClient]);
